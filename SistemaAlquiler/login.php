...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
        <p class="login-box-msg" value="<?php $_SESSION['datos_login']?>">Iniciar su sesión</p>

      <form action="./php/check.php" method="post">
        <div class="input-group mb-3">
            <input type="email" class="form-control" placeholder="Email" name="email" required="" value="danilo@gmail.com">
        ...
        <div class="input-group mb-3">
            <input type="password" class="form-control" placeholder="Contraseña" name="password" required="" value="danilo">
          <div class="input-group-append">
            <div class="input-group-text">
