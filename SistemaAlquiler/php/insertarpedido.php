...
$datos3 = $conexion->query("select id from  contacto order by id desc limit 1")or die($conexion->error);
...
$conexion->query("insert into ventas(id_usuario,id_contacto,total,fecha,status) values($idcliente,$idobra,$total,'$fecha','Preparación')")or die($conexion->error);
