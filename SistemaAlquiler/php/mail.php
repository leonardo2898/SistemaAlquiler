<?php 
    ...
    $message.='<a href="http://localhost:8080/CarritoDeComprasML/verpedido.php?id_venta='.$id_venta.'" style="background-color: brown;color:white;padding: 10px;text-decoration: none;">
